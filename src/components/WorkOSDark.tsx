...
const WorkOSDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="WorkOSDark__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 55.4 48"
    width="100%"
    ...
    {...props}
  >
    <style>{".WorkOSDark__st0{fill:#fff}"}</style>
    <path
      id="WorkOSDark__logo-icon"
      ...
      className="WorkOSDark__st0"
    />
    <path
      id="WorkOSDark__logo-icon_1_"
