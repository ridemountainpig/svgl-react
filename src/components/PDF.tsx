...
const PDF = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#ff2116"
      d="M-29.633 123.947c-3.552 0-6.443 2.894-6.443 6.446v49.498c0 3.551 2.891 6.445 6.443 6.445h37.85c3.552 0 6.443-2.893 6.443-6.445v-40.702s.102-1.191-.416-2.351a6.5 6.5 0 0 0-1.275-1.844l-.006-.008-9.39-9.21-.016-.016s-.802-.764-1.99-1.274c-1.4-.6-2.842-.537-2.842-.537l.021-.002z"
      color="#000"
    ...
    <path
      fill="#f5f5f5"
      d="M-29.633 126.064h28.4s1.135.011 1.965.368a5.4 5.4 0 0 1 1.373.869l9.368 9.19s.564.595.838 1.208c.22.495.234 1.4.234 1.4l-.002.046v40.746a4.294 4.294 0 0 1-4.326 4.328h-37.85a4.294 4.294 0 0 1-4.326-4.328v-49.498a4.294 4.294 0 0 1 4.326-4.328z"
      color="#000"
      fontFamily="sans-serif"
      overflow="visible"
      paintOrder="markers fill stroke"
