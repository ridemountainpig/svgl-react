...
const Procure = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M32.7 2.9v65.9c0 1.4-1.6 2.3-2.8 1.5L2.7 53.2c-1-.7-1.7-1.8-1.7-3.1V21.5c0-1.2.6-2.4 1.7-3.1L30 1.3c1.2-.7 2.7.1 2.7 1.6"
      style={{
        fill: "#fe7f2d",
      }}
    />
