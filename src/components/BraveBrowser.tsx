...
const BraveBrowser = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      >
        ...
        <stop offset="14.13%" stopColor="#FFF" stopOpacity={0.958} />
      ...
      >
        ...
        <stop offset="9.191%" stopColor="#E4E5E6" />
        <stop offset="23.57%" stopColor="#D9DADB" />
        <stop offset="43.8%" stopColor="#D2D4D5" />
        <stop offset="100%" stopColor="#D0D2D3" />
      </linearGradient>
    </defs>
    <path
      fill="#F15A22"
    ...
    <path
      fill="#FFF"
      d="M134 184.801c-1.2-.5-2.5-.9-2.9-.9h-3.2c-.4 0-1.7.4-2.9.9l-13 5.4c-1.2.5-3.2 1.4-4.4 2l-19.6 10.2c-1.2.6-1.3 1.7-.2 2.5l17.3 12.2c1.1.8 2.8 2.1 3.8 3l7.7 6.6c1 .9 2.6 2.3 3.6 3.2l7.4 6.6c1 .9 2.6.9 3.6 0l7.6-6.6c1-.9 2.6-2.3 3.6-3.2l7.7-6.7c1-.9 2.7-2.2 3.8-3l17.3-12.3c1.1-.8 1-1.9-.2-2.5l-19.6-10c-1.2-.6-3.2-1.5-4.4-2z"
    />
    <path
      fill="#FFF"
