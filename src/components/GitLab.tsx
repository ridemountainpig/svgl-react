...
const GitLab = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#FC6D26"
      d="m31.46 12.78-.04-.12a14.75 14.75 0 0 0-5.86 2.64l-9.55 7.24 6.09 4.6 6.67-5h.02a8.09 8.09 0 0 0 2.67-9.36"
    />
    <path
      fill="#FCA326"
    ...
    <path
      fill="#FC6D26"
      d="M6.44 15.3a14.7 14.7 0 0 0-5.86-2.63l-.05.12a8.1 8.1 0 0 0 2.68 9.34l.02.01.04.03 6.63 4.97 6.1-4.6z"
    />
  </svg>
);
