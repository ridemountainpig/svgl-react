...
const WorkOSLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="WorkOSLight__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 55.4 48"
    width="100%"
    ...
    {...props}
  >
    <style>{".WorkOSLight__st0{fill:#6363f1}"}</style>
    <path
      id="WorkOSLight__logo-icon"
      ...
      className="WorkOSLight__st0"
    />
    <path
      id="WorkOSLight__logo-icon_1_"
