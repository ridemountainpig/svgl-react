...
const GoogleCloud = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#FBBC05"
      d="M71.87 61.425C31.94 61.664-.237 94.228.001 134.159a72.3 72.3 0 0 0 28.222 56.88l32.248-32.246c-13.99-6.322-20.208-22.786-13.887-36.776s22.786-20.208 36.775-13.888a27.8 27.8 0 0 1 13.887 13.888l32.248-32.248A72.22 72.22 0 0 0 71.87 61.425"
    />
  </svg>
);
