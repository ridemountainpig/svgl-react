...
const Dogecoin = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <linearGradient id="Dogecoin__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="Dogecoin__b" cx={16} cy={15} r={15} />
      <path
        id="Dogecoin__e"
    ...
    <g fill="none" fillRule="evenodd">
      <use xlinkHref="#Dogecoin__b" fill="#000" filter="url(#Dogecoin__a)" />
      <use xlinkHref="#Dogecoin__b" fill="#C3A634" />
      <use
        xlinkHref="#Dogecoin__b"
        fill="url(#Dogecoin__c)"
        style={{
          mixBlendMode: "soft-light",
        }}
      />
      <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      <use xlinkHref="#Dogecoin__e" fill="#000" filter="url(#Dogecoin__d)" />
      <use xlinkHref="#Dogecoin__e" fill="#FFF" />
    </g>
  </svg>
);
