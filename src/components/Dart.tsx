...
const Dart = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#01579B"
      d="M52.209 203.791 8.413 159.995C3.218 154.67 0 147.141 0 139.782c0-3.407 1.92-8.733 3.369-11.782l40.427-84.204z"
    />
    <path
      fill="#40C4FF"
      d="M202.116 52.209 158.32 8.413C154.5 4.573 146.538 0 139.8 0c-5.796 0-11.48 1.167-15.15 3.369L43.815 43.796zM104.418 256h106.111v-45.471l-79.16-25.276-72.422 25.276z"
    />
    <path
      fill="#29B6F6"
