...
const BNB = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <linearGradient id="BNB__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="BNB__b" cx={16} cy={15} r={15} />
      <path
        id="BNB__e"
    ...
    <g fill="none" fillRule="nonzero">
      <use xlinkHref="#BNB__b" fill="#000" filter="url(#BNB__a)" />
      <use xlinkHref="#BNB__b" fill="#F3BA2F" fillRule="evenodd" />
      <use
        xlinkHref="#BNB__b"
        fill="url(#BNB__c)"
        fillRule="evenodd"
      ...
      <use xlinkHref="#BNB__e" fill="#000" filter="url(#BNB__d)" />
      <use xlinkHref="#BNB__e" fill="#FFF" fillRule="evenodd" />
    </g>
  </svg>
);
export default BNB;
