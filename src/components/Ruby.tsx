...
const Ruby = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <linearGradient id="Ruby__a" x1="84.8%" x2="58.3%" y1="111.4%" y2="64.6%">
      ...
      <linearGradient id="Ruby__b" x1="116.7%" x2="1.7%" y1="60.9%" y2="19.3%">
        <stop offset="0%" stopColor="#871101" />
        <stop offset="0%" stopColor="#871101" />
        <stop offset="99%" stopColor="#911209" />
        <stop offset="100%" stopColor="#911209" />
      </linearGradient>
      <linearGradient id="Ruby__c" x1="75.8%" x2="39%" y1="219.3%" y2="7.8%">
        <stop offset="0%" stopColor="#871101" />
        <stop offset="0%" stopColor="#871101" />
        <stop offset="99%" stopColor="#911209" />
        <stop offset="100%" stopColor="#911209" />
      </linearGradient>
      <linearGradient id="Ruby__d" x1="50%" x2="66.5%" y1="7.2%" y2="79.1%">
      ...
      <linearGradient id="Ruby__e" x1="46.2%" x2="49.9%" y1="16.3%" y2="83%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="Ruby__f" x1="37%" x2="49.5%" y1="15.6%" y2="92.5%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="Ruby__g" x1="13.6%" x2="85.8%" y1="58.3%" y2="-46.7%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="Ruby__h" x1="27.6%" x2="50.7%" y1="21.1%" y2="79.1%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="Ruby__j" x1="58.8%" x2="12%" y1="65.2%" y2="50.1%">
      ...
      <linearGradient id="Ruby__p" x1="30.9%" x2="92.5%" y1="35.6%" y2="100.7%">
    ...
    <path
      fill="url(#Ruby__a)"
      d="M197.5 167.8 51.9 254.2l188.5-12.8 14.5-190z"
    />
    <path fill="url(#Ruby__b)" d="m240.7 241.3-16.2-111.8-44.1 58.2z" />
    <path fill="url(#Ruby__c)" d="m240.9 241.3-118.7-9.4-69.6 22z" />
    <path fill="url(#Ruby__d)" d="m52.7 254 29.7-97.1-65.2 13.9z" />
    <path fill="url(#Ruby__e)" d="M180.4 188 153 81.3l-78 73.2L180.3 188Z" />
    <path fill="url(#Ruby__f)" d="m248.7 82.7-73.8-60.2-20.5 66.4z" />
    <path fill="url(#Ruby__g)" d="m214.2 1-43.4 24L143.4.7z" />
    <path fill="url(#Ruby__h)" d="m0 203.4 18.2-33.2-14.7-39.5z" />
    <path
      fill="#FFF"
      d="m2.5 129.5 14.8 42L81.6 157 155 88.8 175.7 23 143 0 87.6 20.8C70.1 37 36.3 69 35 69.8c-1.2.6-22.4 40.6-32.5 59.7"
    />
    <path
      fill="url(#Ruby__i)"
    ...
    <path
      fill="url(#Ruby__l)"
      d="M248.8 82.8c10-30.2 12.4-73.7-35-81.8l-38.7 21.5z"
    />
    <path fill="#9E1209" d="M0 203c1.4 50 37.4 50.7 52.8 51.1l-35.5-82.9z" />
    <path
      fill="url(#Ruby__m)"
    ...
    <path
      fill="url(#Ruby__n)"
      d="m82.1 156.5 39.3 75.9c23.3-12.7 41.5-28 58.1-44.5z"
    />
    <path
      fill="url(#Ruby__o)"
      d="m17.2 171.3-5.6 66.4c10.5 14.3 25 15.6 40.1 14.5-11-27.4-32.9-82-34.5-80.9"
    />
    <path
      fill="url(#Ruby__p)"
      d="m174.8 22.7 78.1 11C248.8 16 236 4.5 214.1 1z"
    />
  </svg>
);
export default Ruby;
