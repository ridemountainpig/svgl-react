...
const Ruby = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <linearGradient id="prefix__c" x1="75.8%" x2="39%" y1="219.3%" y2="7.8%">
        <stop offset="0%" stopColor="#871101" />
        <stop offset="0%" stopColor="#871101" />
        <stop offset="99%" stopColor="#911209" />
        <stop offset="100%" stopColor="#911209" />
      </linearGradient>
      <linearGradient id="prefix__d" x1="50%" x2="66.5%" y1="7.2%" y2="79.1%">
      ...
      <linearGradient id="prefix__e" x1="46.2%" x2="49.9%" y1="16.3%" y2="83%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="prefix__f" x1="37%" x2="49.5%" y1="15.6%" y2="92.5%">
        <stop offset="0%" stopColor="#FFF" />
        <stop offset="0%" stopColor="#FFF" />
      ...
      <linearGradient id="prefix__j" x1="58.8%" x2="12%" y1="65.2%" y2="50.1%">
      ...
      <linearGradient id="prefix__o" x1="56.6%" x2="3.1%" y1="101.7%" y2="12%">
    ...
    />
    <path fill="url(#prefix__b)" d="m240.7 241.3-16.2-111.8-44.1 58.2z" />
    <path fill="url(#prefix__c)" d="m240.9 241.3-118.7-9.4-69.6 22z" />
    <path fill="url(#prefix__d)" d="m52.7 254 29.7-97.1-65.2 13.9z" />
    <path fill="url(#prefix__e)" d="M180.4 188 153 81.3l-78 73.2L180.3 188Z" />
    <path fill="url(#prefix__f)" d="m248.7 82.7-73.8-60.2-20.5 66.4z" />
    <path fill="url(#prefix__g)" d="m214.2 1-43.4 24L143.4.7z" />
    <path fill="url(#prefix__h)" d="m0 203.4 18.2-33.2-14.7-39.5z" />
    <path
      fill="#FFF"
