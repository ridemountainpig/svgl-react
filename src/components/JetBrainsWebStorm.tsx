...
const JetBrainsWebStorm = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <linearGradient
      xlinkHref="#JetBrainsWebStorm__a"
      id="JetBrainsWebStorm__c"
      x1={88.27}
      x2={93.79}
      y1={25.47}
      y2={45.02}
