...
const UpLeveled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient id="prefix__a" x1="0%" x2="100%" y1=".121%" y2="99.879%">
        <stop offset="0%" stopColor="#FF3367" />
        <stop offset="26.795%" stopColor="#FF3393" />
        <stop offset="100%" stopColor="#844FFF" />
      </linearGradient>
      <linearGradient id="prefix__b" x1="0%" x2="100%" y1=".125%" y2="99.875%">
        <stop offset="0%" stopColor="#FF3367" />
        <stop offset="26.795%" stopColor="#FF3393" />
        <stop offset="100%" stopColor="#844FFF" />
      </linearGradient>
    ...
    />
    <path fill="url(#prefix__b)" d="M17.653 0h136.535v136.364H17.653z" />
    <path
      fill="#FFF"
