...
const Pinia = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path d="M154.99 182.366a14.67 14.67 0 0 1 10.552 3.944 14.67 14.67 0 0 1 4.67 10.25 14.67 14.67 0 0 1-3.944 10.551 14.67 14.67 0 0 1-10.25 4.671 14.67 14.67 0 0 1-10.55-3.945 14.67 14.67 0 0 1-4.672-10.25 14.67 14.67 0 0 1 3.945-10.55 14.67 14.67 0 0 1 10.25-4.671Z" />
    <path
      fill="#FFF"
    ...
    <path
      fill="#FFF"
      d="M155.763 194.668a4.792 4.792 0 1 0-9.578.335 4.792 4.792 0 0 0 9.578-.335"
    />
    <path
      fill="#ECB732"
      d="m38.083 243.16 22.33 23.235 16.022-17.044a3.765 3.765 0 0 1 5.486 5.157l-16.283 17.324 23.1 24.036a3.765 3.765 0 1 1-5.43 5.218l-22.834-23.761-10.725 11.41a3.765 3.765 0 1 1-5.486-5.158l10.986-11.688-22.595-23.511a3.765 3.765 0 1 1 5.43-5.218Zm149.957 0a3.765 3.765 0 1 1 5.429 5.218l-22.596 23.511 10.988 11.688a3.765 3.765 0 0 1-.042 5.201l-.123.121a3.765 3.765 0 0 1-5.322-.165l-10.725-11.41-22.834 23.762a3.765 3.765 0 0 1-5.197.222l-.127-.116a3.765 3.765 0 0 1-.105-5.324l23.1-24.036-16.284-17.324a3.765 3.765 0 0 1 .042-5.2l.123-.121a3.765 3.765 0 0 1 5.321.164l16.021 17.044z"
    />
    <path
      fill="#FFC73B"
