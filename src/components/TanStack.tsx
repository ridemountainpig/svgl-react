...
const TanStack = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <linearGradient id="prefix__b" x1="50%" x2="50%" y1="0%" y2="71.65%">
      ...
      <linearGradient id="prefix__t" x1="57.913%" x2="44.88%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <linearGradient id="prefix__u" x1="50.495%" x2="49.68%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFA400" />
        <stop offset="100%" stopColor="#FF5E00" />
      </linearGradient>
      <circle id="prefix__a" cx={308.5} cy={308.5} r={308.5} />
    </defs>
    <g fill="none" fillRule="evenodd" transform="translate(9 8)">
      ...
      <g mask="url(#prefix__c)">
        <g transform="translate(389 -32)">
          <circle cx={168.5} cy={113.5} r={113.5} fill="url(#prefix__m)" />
          <circle
            cx={168.5}
            cy={113.5}
            r={106}
