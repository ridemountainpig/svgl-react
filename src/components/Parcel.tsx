  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        y2="50.2%"
      >
        <stop offset="0%" stopColor="#C37A44" />
        <stop offset="44.4%" stopColor="#BB713D" />
        <stop offset="64.1%" stopColor="#A05728" />
      ...
      <linearGradient
        ...
        y2="43.4%"
      >
        <stop offset="0%" stopColor="#E9B880" />
      ...
      <linearGradient
        ...
        y2="49.3%"
      >
        <stop offset="0%" stopColor="#C37A45" stopOpacity={0} />
        <stop offset="13.3%" stopColor="#C37A45" />
        <stop offset="29.4%" stopColor="#D08D55" />
        <stop offset="50.2%" stopColor="#DEA167" />
        <stop offset="69.7%" stopColor="#E8AF73" />
        <stop offset="86.3%" stopColor="#ECB477" />
      ...
      <linearGradient
        ...
        y2="77.5%"
      >
        <stop offset="8.8%" stopColor="#AF6938" />
      ...
      <linearGradient
        ...
        y2="49.2%"
      >
        <stop offset="0%" stopColor="#AF6A38" stopOpacity={0} />
        <stop offset="8.6%" stopColor="#AF6A38" />
        <stop offset="19.8%" stopColor="#B87542" />
        <stop offset="58.3%" stopColor="#D59C66" />
      ...
      <linearGradient
        ...
        y2="51.6%"
      >
        <stop offset="4.8%" stopColor="#C69866" />
      ...
      <linearGradient
        ...
        y2="33.5%"
      >
        <stop offset="0%" stopColor="#A9794B" />
        <stop offset="38.6%" stopColor="#AE7F53" />
        <stop offset="45.6%" stopColor="#AC7D50" />
        <stop offset="62.4%" stopColor="#A9794B" />
        <stop offset="100%" stopColor="#B2875D" />
      </linearGradient>
    </defs>
    <path
      fill="url(#prefix__a)"
    ...
    <path
      fill="#D4A271"
      d="M141.4 100c-.4 0-.7.5-.7 1-.1-1-.6-2.3-1.2-2.7l-34.9-22.5.4-.9 34.6 22.4c1.3.8 1.4 1.7 1.4 2.5 0 .2.3.2.4.2"
    />
    ...
    <path
      fill="#322214"
      d="m210.6 111.5-1.6 32.6-23.3 14.5 1.2-34zm-12.4 23.6-11.6 6.8-.5 16 11.5-7.1zm-5.5 6.9v.5c1.3-.7 2.6-.2 3.2 2.1-.4-.5-1.1-.3-1.6.8-.2-.5-1.2-.1-1.4.8l-.4-.2-.3 6.2c0 .6 0 1.1-.7 1.5-.3.2-1.1.3-1-.9l.4-.3c0 .8.1 1 .5.7.5-.2.4-.7.5-1.1l.2-5.9c-.3.2-.6.5-.6.9-.2-.4-1.3-.1-1.5.9-.3-.5-1.2 0-1.5 1 .6-2.8 2.2-5.2 3.7-6.2v-.5zm16.9-13.6-11 6.5-.7 15.7 11-6.8zm-3.5 5.3.4.3-2.4 5.4 2 2.8-.4.7-2-2.8-2.3 5.4-.4-.3 2.5-5.4-2.1-2.9.4-.6 2 2.7zm-6.7 6.2 1.3 1.6-1.4 2.8v-1.2l-.5.3v-1.6l.6-.4V140Zm2.2-2-.3 6-.4.4.2-6 .5-.3Zm2 3.2 1.2 1.4-2.3 1.4 1.2-2.8Zm-12.2.5-.1 1-.3.2v-.3c0-.3.4-1 .4-1Zm10.7-2.8 1 1.3-1.2 2.4zm-7.6 1.5s0 .7-.2 1c0 .2-.1.3-.2.3s-.2-.1-.1-.4zm4.4-21.8-11.7 6.5-.6 16.4 11.6-6.8zm7.7 16.4-.2 6-.4.3.2-6zm-13.2 5s0 .6-.2 1l-.2.2c-.1 0-.2 0-.1-.3 0-.3.4-1 .5-1Zm12.2-3.3-.2 3.9-1-1.3zm2.5-1.8v1.5l.5-.3v1.6l-.6.3v1.4l-1.3-1.5zm-12.8 3s0 .8-.2 1.1l-.3.3v-.4zm9.7-2.2-1.2 2.8-1-1.5zm-8.8-13.7-.1 4.2c-.1 1.4-1.2 4-2.9 5l-.2 3.9 2.3-.5-5.5 3.1 2.3-2.1.1-3.9c-1.4.9-2.6-.7-2.5-2.2v-3.8l1-.5.4 1.8-.5.4 1.1 3.4-.4-3 .4-.5-.3-2.5zm14.2-9.8-11.2 6.2-.7 16.1 11.1-6.6zm-3 13.9v1.9l-6.6 3.8v-1.9l6.7-3.8Zm-4.6-8.3 1.5 3-1.1.7-.3 6.8-1 .6.1-6.8-1 .6zm3.7-2 1.4 3-1.2.6-.2 6.9-1.1.6.3-6.9-1 .6z"
    />
    <path
      fill="#D7AA77"
