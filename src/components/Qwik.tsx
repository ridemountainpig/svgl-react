...
const Qwik = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      >
        ...
        <stop offset="100%" stopColor="#594EE4" />
      </linearGradient>
      <linearGradient
        id="Qwik__b"
        x1="38.874%"
      ...
      >
        ...
        <stop offset="60%" stopColor="#4F48D5" />
        <stop offset="100%" stopColor="#594EE4" />
      </linearGradient>
      <linearGradient
        id="Qwik__d"
      ...
      >
        ...
        <stop offset="60%" stopColor="#2D67F1" />
    ...
    <path
      fill="url(#Qwik__b)"
      d="m242.337 80.408-4.926-9.4-1.932-3.663-.2.196-25.818-47.015C202.984 8.65 190.631 1.231 177.01 1.074l-25.074.206L188.15 114.8l-23.958 23.331 8.924 86.245 73.769-84.021c10.005-11.587 11.97-28.09 4.92-41.646l-9.466-18.302z"
    />
    <path
      fill="url(#Qwik__c)"
      d="m201.113 72.256-43.18-70.907L83.41.003C70.165-.15 57.83 6.573 50.88 17.87L7.01 101.747l34.443-33.334L84.701 8.356l97.894 112.153 18.3-18.626c8.397-8.142 5.54-19.558.22-29.625z"
    />
    <path
      fill="url(#Qwik__d)"
      d="M97.784 95.26 84.522 8.796l-73.148 88.03c-12.328 11.935-14.897 30.662-6.419 45.49l42.98 74.727c6.553 11.464 18.755 18.577 32.024 18.729l42.945.49L71.46 119.607z"
    />
    <path
      fill="url(#Qwik__e)"
