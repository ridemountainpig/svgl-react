...
const Google = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    >
      ...
      <path
        fill="url(#Google__l)"
        d="M237.083 79.025c-6.456 22.526-3.988 44.421 0 57.161 7.457.006 14.64.888 21.45 2.647a77.66 77.66 0 0 1 33.424 18.25l41.88-40.726c-24.81-22.59-54.667-37.297-96.754-37.332"
        filter="url(#Google__k)"
      />
      <path
        fill="url(#Google__m)"
        d="M236.943 78.847c-31.67 0-60.91 9.798-84.871 26.359a145.5 145.5 0 0 0-24.332 21.15c-1.904 17.744 14.257 39.551 46.262 39.37 15.528-17.936 38.495-29.542 64.056-29.542l.07.002-1.044-57.335q-.07-.002-.14-.004Z"
        filter="url(#Google__k)"
      />
      <path
        fill="url(#Google__n)"
      ...
      <path
        fill="url(#Google__r)"
        d="M171.099 290.222c-29.683 10.641-34.33 11.023-37.062 29.29a145 145 0 0 0 16.792 13.984c15.996 11.386 46.766 26.551 86.118 26.551q.068-.002.137-.004v-59.157l-.094.002c-14.736 0-26.512-3.843-38.585-10.527-2.977-1.648-8.378 2.777-11.123.799-3.786-2.729-12.9 2.35-16.183-.938"
        filter="url(#Google__k)"
      />
      <path
        fill="url(#Google__s)"
